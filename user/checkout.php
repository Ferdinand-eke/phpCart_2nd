    ...
    <div class="container">
                    ...
                    <div class="bill-to">
                        ...
                        <div class="form-one">
                            <form name="form1" action="" method="post">
                                <input type="text" placeholder="First Name" name="firstname" required pattern="[A-Za-z]+" title="please enter valid first name [a-z only] " style="width:350px; background-color: #0480be">
                                <input type="text" placeholder="Last Name" name="lastname" required pattern="[A-Za-z]+" title="please enter valid last name [a-z] only" style="width:350px; background-color: #0480be">
                                ...
                                <input type="text" placeholder="Pincode" name="pincode" required pattern="[0-9]{3,6}+" title="please enter valid pin code [0-9 and 6 digits only] only" style="width:350px; background-color: #0480be">
                                <input type="text" placeholder="Contact Number" required pattern="[0-9]{11,13}+" title="please enter valid pin code [0-9 and 6 digits only] only name="cno" style="width:350px; background-color: #0480be">
        ...
        if(isset($_POST["submit1"]))
        {
            ...
            <script type="text/javascript">
                alert("click ok to transfer to you on the paypal payment gateway");

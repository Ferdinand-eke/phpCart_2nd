            ...
            if ($img1 == $values11[0])      //this is for check same cookies available or not if available then increase qty
            {
                ...
                if ($tb_qty < $qty) {
                    ...
                    <script type="text/javascript">
                        window.alert("this much quantity not available");
                    </script>
                <?php
...
//{
//    $d=0;
//    if(isset($_COOKIE['item']))// This is for checking if cookie is available or not
//    {
//        foreach ($_COOKIE['item'] as $name => $value) {
//            $d = $d + 1;
//        }
...
//                $qty=$values11[3]+1;
//                 $total=$values11[2]*$qty;
//                setcookie("item[$name1]", $img1."__".$nm."__".$prize."__".$qty."__".$total,time()+1800); //new
//            }
//        }
//        if($found==0)
//        {
//            setcookie("item[$id]", $img1."__".$nm."__".$prize."__".$qty."__".$total,time()+1800);
//        }
//    }
//    else
//    {
...
<!--    viewing more about each product details-->
